// pages/BarangaySettings.jsx - UPDATED with matching styling from ClientBarangaySettings.jsx
...
const BarangaySettings = () => {
  ...
  // Theme from old ClientSettings.jsx
  const theme = {
    primary: "#2d5a27",
    primaryDark: "#1f451c",
    primaryLight: "#3a6f32",
  ...
  const uploadAvatar = async (file) => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_LARAVEL_API}/profile/avatar`,
        {
          method: "POST",
          headers: {
  ...
  const handleRemoveAvatar = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        showAlert.error(
          "Remove Failed",
          data.message || "Failed to remove avatar"
        );
      }
    } catch (error) {
  ...
  const handleAccountUpdate = async (e) => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_LARAVEL_API}/profile/update`,
        {
          method: "PUT",
          headers: {
  ...
  const handlePasswordChange = async (e) => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_LARAVEL_API}/profile/change-password`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
    ...
    <div className="container-fluid px-1 py-3 fadeIn">
      ...
      <div className="text-center mb-4">
        <div className="d-flex justify-content-center align-items-center mb-3">
          {/* Avatar Section - KEPT FROM CURRENT BUT WITH OLD STYLING */}
      ...
      <div className="row g-3">
        {/* Sidebar Navigation - MATCHING OLD STYLING */}
                  ...
                  style={{
                    background:
                      activeTab === "account"
                        ...
                        : "#f8f9fa",
                    border:
                      activeTab === "account" ? "none" : "1px solid #dee2e6",
                    borderRadius: "8px",
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => {
                      e.target.style.background =
                        "linear-gradient(135deg, rgba(45, 90, 39, 0.2) 0%, rgba(51, 108, 53, 0.2) 100%)";
                    ...
                    <div className="col-12">
                      <button
                        ...
                        onMouseEnter={(e) => {
                          if (!isAccountLoading) {
                            e.target.style.background =
                              "linear-gradient(135deg, #3a6f32 0%, #4a8c47 100%)";
                            e.target.style.transform = "translateY(-2px)";
                            e.target.style.boxShadow =
